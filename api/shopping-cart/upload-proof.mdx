---
title: "Upload a Payment Proof Image to a Cart — TuKit API"
sidebarTitle: "Upload Proof"
description: "Attach one or more payment proof images to an existing shopping cart order so the seller can review and confirm the buyer's transaction."
---
