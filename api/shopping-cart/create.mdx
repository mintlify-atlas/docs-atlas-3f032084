---
title: "Create a Shopping Cart Purchase Order — TuKit API"
...
<ParamField body="products" type="array" required>
  ...
  <Expandable title="Product object fields">
    ...
    <ParamField body="_id" type="string">
      MongoDB `_id` of the product. Read by the controller but not stored on the cart — the cart's product snapshot is sourced from the DB document.
    </ParamField>
    <ParamField body="title" type="string">
      Display title of the product. Read by the controller but not stored on the cart.
    </ParamField>
  </Expandable>
</ParamField>
