---
title: "Get a Single Product by ID from TuKit"
sidebarTitle: "Get Product"
description: "Retrieve the full details of a single marketplace product using its MongoDB ObjectId. Requires a valid token-access JWT. Returns the complete product document."
---
